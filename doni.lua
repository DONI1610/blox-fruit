...
local I = (loadstring(game:HttpGet("https://pastefy.app/PooxGjMZ")))();
if World1 then
	Boss = {
			"The Gorilla King",
			"Bobby",
...
local X = { "Cookie Crafter" };
local P = { "Reborn Skeleton" };
local w = {
...
gay = (function()
		...
		if e and (game:GetService("Lighting") and game:GetService("Lighting")) then
			local I = e:FindFirstChild("DarkFog");
			if I then
				I:Destroy();
			end;
		end;
...
G.Kill = function(I, e)
		if I and e then
			...
			if K == "Blox Fruit" then
				...
				_tp((I.HumanoidRootPart.CFrame * CFrame.new(0, 30, 0)) * CFrame.Angles(0, math.rad(180), 0));
			end;
...
G.Kill2 = function(I, e)
		if I and e then
			...
			if K == "Blox Fruit" then
				...
				_tp((I.HumanoidRootPart.CFrame * CFrame.new(0, 30, 8)) * CFrame.Angles(0, math.rad(180), 0));
			end;
			if RandomCFrame then
				wait(.1);
				_tp(I.HumanoidRootPart.CFrame * CFrame.new(0, 30, 25));
...
BringEnemy = function()
		...
		for I, e in pairs(workspace.Enemies:GetChildren()) do
			if e:FindFirstChild("Humanoid") and e.Humanoid.Health > 0 then
				if (e.PrimaryPart.Position - PosMon).Magnitude <= 300 then
					e.PrimaryPart.CFrame = CFrame.new(PosMon);
					e.PrimaryPart.CanCollide = true;
					(e:FindFirstChild("Humanoid")).WalkSpeed = 0;
					(e:FindFirstChild("Humanoid")).JumpPower = 0;
...
_tp = function(I)
		...
		local K = e.HumanoidRootPart;
		local n = (I.Position - K.Position).Magnitude;
		local d = TweenInfo.new(n / 300, Enum.EasingStyle.Linear);
		local z = (game:GetService("TweenService")):Create(C, d, { CFrame = I });
		if plr.Character.Humanoid.Sit == true then
			C.CFrame = CFrame.new(C.Position.X, I.Y, C.Position.Z);
		end;
		z:Play();
		task.spawn(function()
			while z.PlaybackState == Enum.PlaybackState.Playing do
...
TeleportToTarget = function(I)
		if (I.Position - plr.Character.HumanoidRootPart.Position).Magnitude > 1000 then
			_tp(I);
		else
			_tp(I);
		end;
		...
		pcall(function()
			if _G.SailBoat_Hydra or _G.WardenBoss or _G.AutoFactory or _G.HighestMirage or _G.HCM or _G.PGB or _G.Leviathan1 or _G.UPGDrago or _G.Complete_Trials or _G.TpDrago_Prehis or _G.BuyDrago or _G.AutoFireFlowers or _G.DT_Uzoth or _G.AutoBerry or _G.Prehis_Find or _G.Prehis_Skills or _G.Prehis_DB or _G.Prehis_DE or _G.FarmBlazeEM or _G.Dojoo or _G.CollectPresent or _G.AutoLawKak or _G.TpLab or _G.AutoPhoenixF or _G.AutoFarmChest or _G.AutoHytHallow or _G.LongsWord or _G.BlackSpikey or _G.AutoHolyTorch or _G.TrainDrago or _G.AutoSaber or _G.FarmMastery_Dev or _G.CitizenQuest or _G.AutoEctoplasm or _G.KeysRen or _G.Auto_Rainbow_Haki or _G.obsFarm or _G.AutoBigmom or _G.Doughv2 or _G.AuraBoss or _G.Raiding or _G.Auto_Cavender or _G.TpPly or _G.Bartilo_Quest or _G.Level or _G.FarmEliteHunt or _G.AutoZou or _G.AutoFarm_Bone or (getgenv()).AutoMaterial or _G.CraftVM or _G.FrozenTP or _G.TPDoor or _G.AcientOne or _G.AutoFarmNear or _G.AutoRaidCastle or _G.DarkBladev3 or _G.AutoFarmRaid or _G.Auto_Cake_Prince or _G.Addealer or _G.TPNpc or _G.TwinHook or _G.FindMirage or _G.FarmChestM or _G.Shark or _G.TerrorShark or _G.Piranha or _G.MobCrew or _G.SeaBeast1 or _G.FishBoat or _G.AutoPole or _G.AutoPoleV2 or _G.Auto_SuperHuman or _G.AutoDeathStep or _G.Auto_SharkMan_Karate or _G.Auto_Electric_Claw or _G.AutoDragonTalon or _G.Auto_Def_DarkCoat or _G.Auto_God_Human or _G.Auto_Tushita or _G.AutoMatSoul or _G.AutoKenVTWO or _G.AutoSerpentBow or _G.AutoFMon or _G.Auto_Soul_Guitar or _G.TPGEAR or _G.AutoSaw or _G.AutoTridentW2 or _G.Auto_StartRaid or _G.AutoEvoRace or _G.AutoGetQuestBounty or _G.MarinesCoat or _G.TravelDres or _G.Defeating or _G.DummyMan or _G.Auto_Yama or _G.Auto_SwanGG or _G.SwanCoat or _G.AutoEcBoss or _G.Auto_Mink or _G.Auto_Human or _G.Auto_Skypiea or _G.Auto_Fish or _G.CDK_TS or _G.CDK_YM or _G.CDK or _G.AutoFarmGodChalice or _G.AutoFistDarkness or _G.AutoMiror or _G.Teleport or _G.AutoKilo or _G.AutoGetUsoap or _G.Praying or _G.TryLucky or _G.AutoColShad or _G.AutoUnHaki or _G.Auto_DonAcces or _G.AutoRipIngay or _G.DragoV3 or _G.DragoV1 or _G.SailBoats or NextIs or _G.FarmGodChalice or _G.IceBossRen or senth or senth2 or _G.Lvthan or _G.beasthunter or _G.DangerLV or _G.Relic123 or _G.tweenKitsune or _G.Collect_Ember or _G.AutofindKitIs or _G.snaguine or _G.TwFruits or _G.tweenKitShrine or _G.Tp_LgS or _G.Tp_MasterA or _G.tweenShrine or _G.FarmMastery_G or _G.FarmMastery_S then
				...
				if not plr.Character:FindFirstChild("highlight") then
					...
					I.Name = "highlight";
					I.Enabled = true;
					I.FillColor = Color3.fromRGB(2, 197, 60);
					I.OutlineColor = Color3.fromRGB(255, 255, 255);
					I.FillTransparency = .5;
					I.OutlineTransparency = .2;
...
local y = V:T("Farm");
local c = V:T("Config");
local a = V:T("Fighting Style");
local x = V:T("Items Farm");
local t = V:T("Sea Events");
local m = V:T("Mirage + RaceV4");
local v = V:T("Drago Dojo");
local S = V:T("Prehistoric");
local L = V:T("Raid");
local q = V:T("Combat PVP");
local l = V:T("Teleport");
local B = V:T("Fruits");
local g = V:T("Shop");
local u = V:T("Misc");
local b = y:AddSection("Farm");
local T = c:AddSection("Config");
local U = a:AddSection("Fighting Style");
local j = x:AddSection("Items Farm");
local A = t:AddSection("Sea Events");
local h = m:AddSection("Mirage + RaceV4");
local W = v:AddSection("Drago Dojo");
local f = S:AddSection("Prehistoric");
local s = L:AddSection("Raid");
local E = q:AddSection("Combat PVP");
...
spawn(function()
	while wait(Sec) do
		if _G.Level then
			pcall(function()
				local I = plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text;
				if not string.find(I, (QuestNeta())[5]) then
				...
				elseif plr.PlayerGui.Main.Quest.Visible == true then
					if workspace.Enemies:FindFirstChild((QuestNeta())[1]) then
						for e, K in pairs(workspace.Enemies:GetChildren()) do
							if G.Alive(K) then
								if K.Name == (QuestNeta())[1] then
									if string.find(I, (QuestNeta())[5]) then
										repeat
											wait();
											G.Kill(K, _G.Level);
										until not _G.Level or K.Humanoid.Health <= 0 or not K.Parent or plr.PlayerGui.Main.Quest.Visible == false;
									else
										replicated.Remotes.CommF_:InvokeServer("AbandonQuest");
									end;
								end;
	...
	while wait() do
		pcall(function()
			if _G.AutoFarmNear then
				for I, e in pairs(workspace.Enemies:GetChildren()) do
					if e:FindFirstChild("Humanoid") or e:FindFirstChild("HumanoidRootPart") then
						if e.Humanoid.Health > 0 then
							repeat
								wait();
								G.Kill(e, _G.AutoFarmNear);
							until not _G.AutoFarmNear or not e.Parent or e.Humanoid.Health <= 0;
						end;
					end;
				end;
			end;
	...
	while wait(Sec) do
		pcall(function()
			if _G.AutoFactory then
				local I = GetConnectionEnemies("Core");
				if I then
					repeat
						wait();
						EquipWeapon(_G.SelectWeapon);
						_tp(CFrame.new(448.46756, 199.356781, -441.389252));
					until I.Humanoid.Health <= 0 or _G.AutoFactory == false;
				else
					_tp(CFrame.new(448.46756, 199.356781, -441.389252));
				end;
			end;
...
spawn(function()
	while wait(Sec) do
		if _G.AutoRaidCastle then
			pcall(function()
				local I = CFrame.new(-5496.17432, 313.768921, -2841.53027, .924894512, 7.37058015e-09, .380223751, 3.5881019e-08, 1, -1.06665446e-07, -0.380223751, 1.12297109e-07, .924894512);
				if ((CFrame.new(-5539.3115234375, 313.80053710938, -2972.3723144531)).Position - Root.Position).Magnitude <= 500 then
					...
					for K = 1, #e, 1 do
						if replicated:FindFirstChild(e[K]) then
							for K, n in pairs(replicated:GetChildren()) do
								if table.find(e, n.Name) then
									_tp(I);
								end;
							end;
						end;
		...
		pcall(function()
			if _G.AutoEctoplasm then
				...
				if G.Alive(e) then
					repeat
						wait();
						G.Kill(e, _G.AutoEctoplasm);
					until not _G.AutoEctoplasm or not e.Parent or e.Humanoid.Health <= 0;
				else
					replicated.Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(923.21252441406, 126.9760055542, 32852.83203125));
				end;
			end;
	...
	while wait(.1) do
		pcall(function()
			if _G.Bartilo_Quest and Lv >= 850 then
				local I = plr.PlayerGui.Main.Quest;
				if replicated.Remotes.CommF_:InvokeServer("BartiloQuestProgress", "Bartilo") == 0 then
					_G.Level = false;
					if I.Visible == true then
						local e = GetConnectionEnemies("Swan Pirate");
						if e then
							local e = GetConnectionEnemies(z);
							if e then
								repeat
									task.wait();
									if not string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Swan Pirate") then
										...
										G.Kill(e, _G.Bartilo_Quest);
									end;
								until _G.Bartilo_Quest == false or not e.Parent or e.Humanoid.Health <= 0 or I.Visible == false or not e:FindFirstChild("HumanoidRootPart");
							end;
						else
...
spawn(function()
	while wait(Sec) do
		if _G.DummyMan then
			pcall(function()
				if plr.PlayerGui.Main.Quest.Visible == false then
					local I = { [1] = "ArenaTrainer" };
					((replicated:WaitForChild("Remotes")):WaitForChild("CommF_")):InvokeServer(unpack(I));
				else
					local I = GetConnectionEnemies("Training Dummy");
					if I then
						repeat
							wait();
							G.Kill(I, _G.DummyMan);
						until not _G.DummyMan or not I.Parent or I.Humanoid.Health <= 0;
					else
	...
	RunSer.RenderStepped:Connect(function()
		pcall(function()
			if _G.FarmMastery_Dev or _G.FarmMastery_G or _G.FarmMastery_S then
				for I, e in pairs(plr.PlayerGui.Notifications:GetChildren()) do
					if e.Name == "NotificationTemplate" then
						if string.find(e.Text, "Skill locked!") then
							e:Destroy();
						end;
					end;
				end;
		...
		if _G.FarmMastery_Dev then
			pcall(function()
				if SelectIsland == "Cake" then
					local I = GetConnectionEnemies(X);
					if I then
						HealthM = (I.Humanoid.MaxHealth * 70) / 100;
						repeat
							wait();
							MousePos = I.HumanoidRootPart.Position;
							G.Mas(I, _G.FarmMastery_Dev);
						until _G.FarmMastery_Dev == false or I.Humanoid.Health <= 0 or not I.Parent;
					else
						_tp(CFrame.new(-1943.6765136719, 251.50956726074, -12337.880859375));
					end;
				elseif SelectIsland == "Bone" then
					local I = GetConnectionEnemies(P);
					if I then
						HealthM = (I.Humanoid.MaxHealth * 70) / 100;
						repeat
							wait();
				...
				if SelectIsland == "Cake" then
					...
					if I then
						...
						repeat
							wait();
							MousePos = I.HumanoidRootPart.Position;
							G.Masgun(I, _G.FarmMastery_G);
							local e = replicated:FindFirstChild("Modules");
							local K = e:FindFirstChild("Net");
							local n = K:FindFirstChild("RE/ShootGunEvent");
							...
							elseif plr.Character:FindFirstChildOfClass("Tool") and (plr.Character:FindFirstChildOfClass("Tool")).Name ~= "Skull Guitar" then
								SoulGuitar = false;
								n:FireServer(MousePos, { I.HumanoidRootPart });
								if _G.FarmMastery_G then
									vim1:SendMouseButtonEvent(0, 0, 0, true, game, 1);
									wait(.05);
									vim1:SendMouseButtonEvent(0, 0, 0, false, game, 1);
						...
						until _G.FarmMastery_G == false or I.Humanoid.Health <= 0 or not I.Parent;
						SoulGuitar = false;
					else
						_tp(CFrame.new(-1943.6765136719, 251.50956726074, -12337.880859375));
					end;
	...
	while wait(Sec) do
		pcall(function()
			if _G.FarmMastery_S then
				if SelectIsland == "Cake" then
					for I, e in next, replicated.Remotes.CommF_:InvokeServer("getInventory") do
						if type(e) == "table" then
							if e.Type == "Sword" then
								SwordName = e.Name;
								if tonumber(e.Mastery) >= 1 or tonumber(e.Mastery) <= 599 then
									local I = GetConnectionEnemies(X);
									if GetBP(SwordName) then
										if I then
											repeat
												wait();
												G.Sword(I, _G.FarmMastery_S);
											until _G.FarmMastery_S == false or not I.Parent or I.Humanoid.Healh <= 0;
										else
											_tp(CFrame.new(-1943.6765136719, 251.50956726074, -12337.880859375));
										end;
									else
								...
								elseif tonumber(e.Mastery) >= 600 then
									if GetBP(SwordName) then
										return nil;
									else
										replicated.Remotes.CommF_:InvokeServer("LoadItem", SwordName);
...
local R = b:AddParagraph({ Title = "Cake Princes :", Content = "" });
local N = b:AddParagraph({ Title = " Bones :", Content = "" });
spawn(function()
	while wait(.2) do
		pcall(function()
			local I = string.match(replicated.Remotes.CommF_:InvokeServer("CakePrinceSpawner"), "%d+");
			if I then
				R:SetDesc(" Killed : " .. 500 - I);
			end;
		end);
	end;
end);
	...
	while wait() do
		if _G.Auto_Cake_Prince then
			pcall(function()
				local I = game.Players.LocalPlayer;
				local e = I.Character and I.Character:FindFirstChild("HumanoidRootPart");
				local K = I.PlayerGui.Main.Quest;
				local n = workspace.Enemies;
				local d = workspace.Map.CakeLoaf.BigMirror;
				if not e then
					return;
				end;
				if not d:FindFirstChild("Other") then
					_tp(CFrame.new(-2077, 252, -12373));
				end;
				if d.Other.Transparency == 0 or n:FindFirstChild("Cake Prince") then
					local I = GetConnectionEnemies("Cake Prince");
					if I then
						repeat
							wait();
							G.Kill2(I, _G.Auto_Cake_Prince);
						until not _G.Auto_Cake_Prince or not I.Parent or I.Humanoid.Health <= 0;
					else
						if d.Other.Transparency == 0 and ((CFrame.new(-1990.67, 4533, -14973.67)).Position - e.Position).Magnitude >= 2000 then
					...
					local n = GetConnectionEnemies(I);
					if n then
						if _G.AcceptQuestC and not K.Visible then
							local I = CFrame.new(-1927.92, 37.8, -12842.54);
							_tp(I);
							while (I.Position - e.Position).Magnitude > 50 do
								wait(.2);
							end;
							...
							local d, z = pcall(function()
									return game.ReplicatedStorage.Remotes.CommF_:InvokeServer(unpack(n[K]));
								end);
						end;
						repeat
							wait();
							G.Kill(n, _G.Auto_Cake_Prince);
						until not _G.Auto_Cake_Prince or n.Humanoid.Health <= 0 or d.Other.Transparency == 0 or _G.AcceptQuestC and not K.Visible;
					else
						_tp(CFrame.new(-2077, 252, -12373));
					end;
				end;
	...
	while wait(Sec) do
		if _G.AutoFarm_Bone then
			pcall(function()
				...
				local d = GetConnectionEnemies(n);
				if d then
					if _G.AcceptQuestC and not K.Visible then
						local I = CFrame.new(-9516.99316, 172.017181, 6078.46533, 0, 0, -1, 0, 1, 0, 1, 0, 0);
						_tp(I);
						while (I.Position - e.Position).Magnitude > 50 do
							wait(.2);
						end;
					...
					repeat
						task.wait();
						G.Kill(d, _G.AutoFarm_Bone);
					until not _G.AutoFarm_Bone or d.Humanoid.Health <= 0 or not d.Parent or _G.AcceptQuestC and not K.Visible;
				else
					_tp(CFrame.new(-9495.6806640625, 453.58624267578, 5977.3486328125));
				end;
			end);
...
spawn(function()
	while wait(Sec) do
		if _G.AutoMiror then
			pcall(function()
				local I = GetConnectionEnemies("Dough King");
				if I then
					repeat
						wait();
						G.Kill(I, _G.AutoMiror);
					until not _G.AutoMiror or not I.Parent or I.Humanoid.Health <= 0;
				else
					_tp(CFrame.new(-1943.6765136719, 251.50956726074, -12337.880859375));
				end;
			end);
		...
		if _G.AutoHytHallow then
			pcall(function()
				...
				if I then
					repeat
						task.wait();
						G.Kill(I, _G.AutoHytHallow);
					until I.Humanoid.Health <= 0 or _G.AutoHytHallow == false;
				else
...
spawn(function()
	while wait(Sec) do
		if _G.TryLucky then
			local I = CFrame.new(-8761.3154296875, 164.85829162598, 6161.1567382813);
			if plr.Character.HumanoidRootPart.CFrame ~= I then
				_tp(CFrame.new(-8761.3154296875, 164.85829162598, 6161.1567382813));
			elseif plr.Character.HumanoidRootPart.CFrame == I then
		...
		if _G.Doughv2 then
			pcall(function()
				...
				elseif GetConnectionEnemies("Dough King") then
					...
					if I then
						repeat
							wait();
							G.Kill(I, _G.Doughv2);
						until not _G.Doughv2 or not I.Parent or I.Humanoid.Health <= 0;
					else
						_tp(CFrame.new(-1943.6765136719, 251.50956726074, -12337.880859375));
					end;
				end;
				...
				if GetM("Conjured Cocoa") <= 10 then
					local I = { "Cocoa Warrior", "Chocolate Bar Battler" };
					local e = GetConnectionEnemies(I);
					if e then
						repeat
							wait();
							G.Kill(e, _G.Doughv2);
						until _G.Doughv2 == false or not e.Parent or e.Humanoid.Health <= 0;
					else
					...
					elseif replicated.Remotes.CommF_:InvokeServer("Alchemist", "1") == 1 then
						...
						elseif not plr.Backpack:FindFirstChild("Flower 3") and not plr.Character:FindFirstChild("Flower 3") then
							...
							if I then
								repeat
									wait();
									G.Kill(I, _G.Auto_Mink);
								until GetBP("Flower 3") or not I.Parent or I.Humanoid.Health <= 0 or _G.Auto_Mink == false;
							else
			...
			if _G.Auto_Human then
					...
					elseif replicated.Remotes.CommF_:InvokeServer("Alchemist", "1") == 1 then
						...
						elseif not plr.Backpack:FindFirstChild("Flower 3") and not plr.Character:FindFirstChild("Flower 3") then
							...
							if I then
								...
								until plr.Backpack:FindFirstChild("Flower 3") or not I.Parent or I.Humanoid.Health <= 0 or _G.Auto_Human == false;
							else
								_tp(CFrame.new(980.09851074219, 121.33129882812, 1287.2093505859));
							end;
						end;
				...
				elseif replicated.Remotes.CommF_:InvokeServer("Wenlocktoad", "1") == 1 then
					...
					if K then
						...
						until K.Humanoid.Health <= 0 or not K.Parent or not _G.Auto_Human;
					else
					...
					elseif replicated.Remotes.CommF_:InvokeServer("Alchemist", "1") == 1 then
						...
						elseif not plr.Backpack:FindFirstChild("Flower 3") and not plr.Character:FindFirstChild("Flower 3") then
							...
							if I then
								repeat
									wait();
									G.Kill(I, _G.Auto_Skypiea);
								until plr.Backpack:FindFirstChild("Flower 3") or not I.Parent or I.Humanoid.Health <= 0 or _G.Auto_Skypiea == false;
							else
								_tp(CFrame.new(980.09851074219, 121.33129882812, 1287.2093505859));
							end;
						end;
				...
				elseif replicated.Remotes.CommF_:InvokeServer("Wenlocktoad", "1") == 1 then
					for I, e in pairs(game.Players:GetChildren()) do
						if e.Name ~= plr.Name and tostring(e.Data.Race.Value) == "Skypiea" then
							repeat
								task.wait();
								_tp((e.HumanoidRootPart.CFrame * CFrame.new(0, 8, 0)) * CFrame.Angles(math.rad(-45), 0, 0));
							until e.Humanoid.Health <= 0 or _G.Auto_Skypiea == false;
						end;
					end;
				end;
			end;
					...
					elseif replicated.Remotes.CommF_:InvokeServer("Alchemist", "1") == 1 then
						...
						elseif not plr.Backpack:FindFirstChild("Flower 3") and not plr.Character:FindFirstChild("Flower 3") then
							...
							if I then
								repeat
									wait();
									G.Kill(I, _G.Auto_Fish);
								until plr.Backpack:FindFirstChild("Flower 3") or not I.Parent or I.Humanoid.Health <= 0 or _G.Auto_Fish == false;
							else
								_tp(CFrame.new(980.09851074219, 121.33129882812, 1287.2093505859));
							end;
						end;
...
T:AddSeperator("Settings / Configure");
T:AddDropdown({
	Title = "Select Weapon",
	Description = "",
	Values = {
	...
	while wait(Sec) do
		pcall(function()
			if _G.ChooseWP == "Melee" then
				for I, e in pairs(plr.Backpack:GetChildren()) do
					if e.ToolTip == "Melee" then
						if plr.Backpack:FindFirstChild(tostring(e.Name)) then
...
spawn(function()
	while task.wait(Sec) do
		pcall(function()
			if _G.Safemode then
				local I = (plr.Character.Humanoid.Health / plr.Character.Humanoid.MaxHealth) * 100;
				if I < Num_self then
					shouldTween = true;
	...
	while wait(Sec) do
		if _G.DistroyHit then
			pcall(function()
				...
				for I, e in pairs(workspace._WorldOrigin:GetChildren()) do
					if table.find(__Effect, e.Name) then
						e:Destroy();
					end;
				end;
			end);
...
U:AddSeperator("Fighting Melee Styles");
U:AddToggle({
	Title = "Auto Superhuman",
	Description = "",
	Default = false,
	Callback = function(I)
		_G.Auto_SuperHuman = I;
	end,
});
spawn(function()
	while wait(Sec) do
		pcall(function()
			if _G.Auto_SuperHuman then
				local I = plr.Data.Beli.Value;
				local e = plr.Data.Fragments.Value;
							...
							if workspace.Map.IceCastle.Hall.LibraryDoor.PhoeyuDoor.Transparency == 0 then
								...
								elseif not GetBP("Library Key") then
									...
									if I then
										repeat
											wait();
											G.Kill(I, _G.AutoDeathStep);
										until not I.Parent or I.Humanoid.Health <= 0 or _G.AutoDeathStep == false or GetBP("Library Key") or GetBP("Death Step");
									else
						...
						if GetBP("Fishman Karate") or (GetBP("Fishman Karate")).Level.Value >= 400 then
							...
							elseif not GetBP("Water Key") then
								...
								if I then
									repeat
										wait();
										G.Kill(I, _G.Auto_SharkMan_Karate);
									until not I.Parent or I.Humanoid.Health <= 0 or _G.Auto_SharkMan_Karate == false or GetBP("Water Key") or GetBP("Sharkman Karate");
								else
			...
			pcall(function()
				...
				if not GetBP("Sanguine Art") then
					...
					if GetM("Vampire Fang") <= 19 then
						if World2 then
							local I = GetConnectionEnemies("Vampire");
							if I then
								repeat
									task.wait();
									G.Kill(I, _G.snaguine);
								until not _G.snaguine or I.Humanoid.Health <= 0 or not I.Parent;
							else
					...
					if GetM("Vampire Fang") >= 20 and GetM("Demonic Wisp") <= 19 then
						if World3 then
							local I = GetConnectionEnemies("Demonic Soul");
							if I then
								repeat
									task.wait();
									G.Kill(I, _G.snaguine);
...
FullMOOn = h:AddParagraph({ Title = " FullMoon Status ", Content = "" });
Ismirage = h:AddParagraph({ Title = " Mirage Island Status ", Content = "" });
spawn(function()
	while wait(.2) do
...
spawn(function()
	pcall(function()
		while wait(.1) do
			if _G.TPGEAR then
				for I, e in pairs((workspace.Map:FindFirstChild("MysticIsland")):GetChildren()) do
					if e.Name == "Part" and e.ClassName == "MeshPart" then
						_tp(e.CFrame);
					end;
				end;
			end;
...
h:AddSeperator("Skull Guitars / Misc");
local e5 = h:AddParagraph({ Title = " Skull Guitar Quests ", Content = "" });
spawn(function()
	while wait(.2) do
		pcall(function()
			if Quest1 == true then
				e5:SetDesc(" Quest Number : Quest1");
			elseif Quest2 == true then
				e5:SetDesc(" Quest Number : Quest2");
			elseif Quest3 == true then
				e5:SetDesc(" Quest Number : Quest3");
			elseif Quest4 == true then
				e5:SetDesc(" Quest Number : Quest4");
			elseif GetWP("Skull Guitar") then
				e5:SetDesc(" Quest Number : Collect!!");
			else
				e5:SetDesc(" Quest Number : No Quest!!");
			end;
		end);
	end;
end);
...
h:AddButton({ Title = "Talk With Stone", Description = "", Callback = function()
...
local n5 = f:AddParagraph({ Title = " Prehistoric Island Status ", Content = "" });
spawn(function()
	while wait(.2) do
		if workspace.Map:FindFirstChild("PrehistoricIsland") or workspace._WorldOrigin.Locations:FindFirstChild("Prehistoric Island") then
			n5:SetDesc(" Prehistoric Island : True");
		else
			n5:SetDesc(" Prehistoric Island : False");
		end;
	end;
end);
f:AddToggle({
				...
				if not workspace._WorldOrigin.Locations:FindFirstChild("Prehistoric Island", true) then
					...
					if not I then
						...
						if plr.Character.Humanoid.Sit == false then
							...
							until not _G.Prehis_Find or (I.Position - plr.Character.HumanoidRootPart.Position).Magnitude <= 10 or workspace._WorldOrigin.Locations:FindFirstChild("Prehistoric Island") or plr.Character.Humanoid.Sit == false;
							plr.Character.Humanoid.Sit = false;
						end;
					end;
				else
...
spawn(function()
	while wait() do
		if _G.Prehis_Skills then
			local I = game.Workspace.Map:FindFirstChild("PrehistoricIsland");
			if I then
				for I, e in pairs(I:GetDescendants()) do
					if e:IsA("Part") and (e.Name:lower()):find("lava") then
						e:Destroy();
					end;
					if e:IsA("MeshPart") and (e.Name:lower()):find("lava") then
						e:Destroy();
					end;
				end;
				local e = game.Workspace.Map.PrehistoricIsland.Core:FindFirstChild("InteriorLava");
				if e and e:IsA("Model") then
					e:Destroy();
				end;
				local K = workspace.Map:FindFirstChild("PrehistoricIsland");
				if K then
					local I = workspace.Map.PrehistoricIsland:FindFirstChild("TrialTeleport");
					for e, K in pairs(K:GetDescendants()) do
						if K.Name == "TouchInterest" then
							if not (I and K:IsDescendantOf(I)) then
								K.Parent:Destroy();
							end;
						end;
					end;
		...
		pcall(function()
			if _G.Prehis_Skills then
				if workspace.Enemies:FindFirstChild("Lava Golem") then
					local I = GetConnectionEnemies("Lava Golem");
					if I then
						repeat
							wait();
							G.Kill(I, _G.Prehis_Skills);
							I.Humanoid:ChangeState(15);
						until not _G.Prehis_Skills or not I.Parent or I.Humanoid.Health <= 0;
					end;
				end;
				for I, e in pairs(game.Workspace.Map.PrehistoricIsland.Core.VolcanoRocks:GetChildren()) do
					if e:FindFirstChild("VFXLayer") then
						if (e:FindFirstChild("VFXLayer")).At0.Glow.Enabled == true or e.VFXLayer.At0.Glow.Enabled == true then
							repeat
								wait();
								_tp(e.VFXLayer.CFrame);
								if e.VFXLayer.At0.Glow.Enabled == true and plr:DistanceFromCharacter(e.VFXLayer.CFrame.Position) <= 150 then
									MousePos = e.VFXLayer.CFrame.Position;
									Useskills("Melee", "Z");
									wait(.5);
									Useskills("Melee", "X");
									wait(.5);
							...
							until not _G.Prehis_Skills or (e:FindFirstChild("VFXLayer")).At0.Glow.Enabled == false or e.VFXLayer.At0.Glow.Enabled == false;
						end;
					end;
				end;
			end;
...
spawn(function()
	while wait(Sec) do
		pcall(function()
			if _G.ResetPH then
				local I = workspace.Map.PrehistoricIsland:FindFirstChild("TrialTeleport");
				if I and I:FindFirstChild("TouchInterest") then
...
local F5 = A:AddParagraph({ Title = " Spy Status ", Content = "" });
spawn(function()
	while wait(.2) do
		pcall(function()
			local I = string.match(replicated.Remotes.CommF_:InvokeServer("InfoLeviathan", "1"), "%d+");
			if I then
				F5:SetDesc(" Spy Leviathan  : " .. tostring(I));
				if tostring(I) == 5 then
					F5:SetDesc(" Spy Leviathan : Already Done!!");
				end;
			end;
		end);
	end;
end);
A:AddButton({ Title = "Buy Fracments with Spy", Description = "Buy the spy for finding leviathan", Callback = function()
		((replicated:WaitForChild("Remotes")):WaitForChild("CommF_")):InvokeServer("InfoLeviathan", "2");
	end });
local Q5 = A:AddParagraph({ Title = " FlozenDimension Status ", Content = "" });
spawn(function()
	pcall(function()
		while wait(.2) do
			if workspace._WorldOrigin.Locations:FindFirstChild("Frozen Dimension") then
				Q5:SetDesc(" Flozen Dimension : True");
			else
				Q5:SetDesc(" Flozen Dimension : False");
			end;
		end;
	end);
end);
...
A:AddButton({ Title = "Buy Boats", Description = "Buy the select boats", Callback = function()
		replicated.Remotes.CommF_:InvokeServer("BuyBoat", _G.SelectedBoat);
	end });
A:AddDropdown({
...
local X5 = A:AddParagraph({ Title = " Kitsune Island Status ", Content = "" });
spawn(function()
	while wait(.2) do
		if workspace.Map:FindFirstChild("KitsuneIsland") or workspace._WorldOrigin.Locations:FindFirstChild("Kitsune Island") then
			X5:SetDesc(" Kitsune Island : True");
		else
			X5:SetDesc(" Kitsune Island : False");
		end;
	end;
end);
A:AddToggle({
...
s:AddSeperator("Dungeon Event / Raiding");
local P5 = s:AddParagraph({ Title = " Raiding Status ", Content = "" });
spawn(function()
	while wait(.2) do
		pcall(function()
			if plr.PlayerGui.Main.Timer.Visible == true then
				P5:SetDesc(" Raiding Statud : True");
			else
				P5:SetDesc(" Raiding Statud : False");
			end;
		end);
	end;
end);
...
s:AddButton({ Title = "Buy Dungeon Chips [Beli]", Description = "", Callback = function()
		if not GetBP("Special Microchip") then
			replicated.Remotes.CommF_:InvokeServer("RaidsNpc", "Select", _G.SelectChip);
		end;
	end });
s:AddButton({ Title = "Buy Dungeon Chips [Devil Fruit]", Description = "Use your lowest fruit in your bag", Callback = function()
		if GetBP("Special Microchip") then
			return;
		end;
		local I = {};
		local K = {};
		for e, K in next, (replicated:WaitForChild("Remotes")).CommF_:InvokeServer("GetFruits") do
			if K.Price <= 490000 then
				table.insert(I, K.Name);
			end;
		end;
		for I, K in pairs(I) do
			for I, e in pairs(e) do
				if not GetBP("Special Microchip") then
					replicated.Remotes.CommF_:InvokeServer("LoadFruit", tostring(K));
					replicated.Remotes.CommF_:InvokeServer("RaidsNpc", "Select", _G.SelectChip);
				end;
			end;
		end;
	end });
s:AddSeperator("Raiding Menu");
s:AddToggle({
			...
			if _G.Raiding then
				if plr.PlayerGui.Main.TopHUDList.RaidTimer.Visible == true then
					...
					for I, e in ipairs(I) do
						local K = (game:GetService("Workspace"))._WorldOrigin.Locations:FindFirstChild(e);
						if K then
							for I, e in pairs(workspace.Enemies:GetChildren()) do
								if e:FindFirstChild("Humanoid") or e:FindFirstChild("HumanoidRootPart") then
									if e.Humanoid.Health > 0 then
										repeat
											...
											G.Kill(e, _G.Raiding);
											NextIs = false;
										until not _G.Raiding or not e.Parent or e.Humanoid.Health <= 0;
										NextIs = true;
									end;
								end;
							end;
			...
			for I, e in pairs(workspace.Enemies:GetChildren()) do
				if G.Alive(e) then
					pcall(function()
						...
						until not _G.KillH or not e.Parent or e.Humanoid.Health <= 0;
					end);
				end;
			end;
		end;
...
E:AddSeperator("Esp Items / Entity / Island");
function isnil(I)
	return I == nil;
end;
local function G5(I)
...
Y:AddButton({ Title = "Travel East Blue (World 1)", Description = "", Callback = function()
		replicated.Remotes.CommF_:InvokeServer("TravelMain");
	end });
Y:AddButton({ Title = "Travel Dressrosa (World 2)", Description = "", Callback = function()
		replicated.Remotes.CommF_:InvokeServer("TravelDressrosa");
	end });
Y:AddButton({ Title = "Travel Zou (World 3)", Description = "", Callback = function()
		replicated.Remotes.CommF_:InvokeServer("TravelZou");
	end });
...
Z:AddSeperator("Server - Function");
Z:AddButton({ Title = "Rejoin Server", Description = "", Callback = function()
		(game:GetService("TeleportService")):Teleport(game.PlaceId, game.Players.LocalPlayer);
	end });
Z:AddButton({ Title = "Hop Server", Description = "", Callback = function()
		Hop();
	end });
Z:AddButton({ Title = "Hop to Lowest Players", Description = "", Callback = function()
...
Z:AddButton({ Title = "Hop to Lowest Pings Server", Description = "", Callback = function()
		local I = game:GetService("HttpService");
		local e = game:GetService("TeleportService");
...
Z:AddButton({ Title = "Teleport [Job ID]", Description = "", Callback = function()
		replicated.__ServerBrowser:InvokeServer("teleport", _G.JobId);
	end });
Z:AddButton({ Title = "Copy JobID", Description = "", Callback = function()
		setclipboard(tostring(game.JobId));
	end });
Z:AddSeperator("Player Gui / Others");
...
Z:AddToggle({
	...
	Callback = function(I)
		...
		if _G.Rechat then
			e:SetCoreGuiEnabled(Enum.CoreGuiType.Chat, false);
		else
			e:SetCoreGuiEnabled(Enum.CoreGuiType.Chat, true);
		end;
	end,
});
Z:AddToggle({
...
Z:AddSeperator("Graphics / Haki Stats");
HakiSt = {
		"State 0",
		"State 1",
		"State 2",
...
Z:AddButton({ Title = "ChangeBusoStage", Description = "", Callback = function()
...
Z:AddToggle({
	...
	Callback = function(I)
		_G.RTXMode = I;
		local e = game.Lighting;
		local K = Instance.new("ColorCorrectionEffect", e);
		local n = Instance.new("ColorCorrectionEffect", e);
		local d = e.Ambient;
		local z = e.Brightness;
		local H = e.ColorShift_Top;
		local F = K.Brightness;
		local Q = K.Contrast;
		local X = K.TintColor;
		local P = n.TintColor;
		spawn(function()
			while _G.RTXMode do
				wait();
				e.Ambient = Color3.fromRGB(33, 33, 33);
				e.Brightness = .3;
				K.Brightness = .176;
				K.Contrast = .39;
				K.TintColor = Color3.fromRGB(217, 145, 57);
				game.Lighting.FogEnd = 999;
				if not plr.Character.HumanoidRootPart:FindFirstChild("PointLight") then
					local I = Instance.new("PointLight");
					I.Parent = plr.Character.HumanoidRootPart;
					I.Range = 15;
					I.Color = Color3.fromRGB(217, 145, 57);
				end;
			end;
			e.Ambient = d;
			e.Brightness = z;
			...
			local I = plr.Character.HumanoidRootPart:FindFirstChild("PointLight");
			if I then
				I:Destroy();
			end;
		end);
...
Z:AddButton({ Title = "Turn on Fast Mode", Description = "", Callback = function()
		for I, e in next, workspace:GetDescendants() do
			if table.find(d, e.ClassName) then
				e.Material = "Plastic";
			end;
		end;
	end });
Z:AddButton({ Title = "Turn on Low CPU", Description = "", Callback = function()
		LowCpu();
	end });
Z:AddButton({ Title = "Turn on increase Boats", Description = "", Callback = function()
		for I, e in pairs(workspace.Boats:GetDescendants()) do
			if table.find(z5, e.Name) and tostring(e.Owner.Value) == tostring(plr.Name) then
				e.VehicleSeat.MaxSpeed = 350;
				e.VehicleSeat.Torque = .2;
				e.VehicleSeat.TurnSpeed = 5;
				e.VehicleSeat.HeadsUpDisplay = true;
			end;
		end;
	end });
Z:AddButton({ Title = "Remove Sky Fog", Description = "", Callback = function()
...
Z:AddSeperator("Configure - God");
Z:AddButton({ Title = "Rain Fruits (Client)", Description = "", Callback = function()
		for I, e in pairs((game:GetObjects("rbxassetid://14759368201"))[1]:GetChildren()) do
			e.Parent = game.Workspace.Map;
			e:MoveTo(plr.Character.PrimaryPart.Position + Vector3.new(math.random(-50, 50), 100, math.random(-50, 50)));
			if e.Fruit:FindFirstChild("AnimationController") then
				((e.Fruit:FindFirstChild("AnimationController")):LoadAnimation(e.Fruit:FindFirstChild("Idle"))):Play();
			end;
			e.Handle.Touched:Connect(function(I)
				if I.Parent == plr.Character then
					e.Parent = plr.Backpack;
					plr.Character.Humanoid:EquipTool(e);
				end;
			end);
		end;
	end });
		...
		if _G.WalkWater then
			pcall(function()
				if plr.Character and plr.Character:FindFirstChild("LeftFoot") then
					local I = replicated.Assets.Models.IceSpikes4:Clone();
					I.Parent = workspace;
					I.Size = Vector3.new(3 + math.random(10, 12), 1.7, 3 + math.random(10, 12));
					I.Color = Color3.fromRGB(128, 187, 219);
					I.CFrame = CFrame.new(plr.Character.Head.Position.X, -3.8, plr.Character.Head.Position.Z) * CFrame.Angles((math.random() - .5) * .06, math.random() * 7, (math.random() - .5) * .07);
					local e = {};
					e.Size = Vector3.new(0, .3, 0);
					local K = TW:Create(I, TweenInfo.new(2, Enum.EasingStyle.Quad, Enum.EasingDirection.In), e);
